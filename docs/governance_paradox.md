...
If your goal is to create an absolute, non-negotiable mathematical and ethical fortress, then perhaps it doesn't need to be built together.
Perhaps you build the core engine and the mathematical proofs entirely yourself, and the repository simply becomes a locked standard that the world must either adopt or fail to pass.
